...
<div class="row" >
	<div class="col-md-8 col-md-offset-2" style="padding-top: 5%">
	 <div class="panel panel-success text-center">
		...
		<?php echo form_open('relatorio/relatorio_uso_motorista', array('class' => 'form-horizontal'));?>
	  <div class="panel-heading"><strong><?php echo $title;?></strong></div>
			...
			<div class="panel-body">
						...
						<?php if($dados_uso == ""){?>
						  ...
						  <label for="motorista" class="col-md-3 control-label">Motorista</label>
							<div class="col-md-4">
								...
								<table class="table table-striped">
									<thead class="text-center">
										<tr>
											<td>Motorista</td>
											<td>Veículo</td>
											<td>Quilometragem na Saída</td>
											<td>Quilometragem no Retorno</td>
			...
			<div class="panel-footer">
				...
				<?php }else{?>
					<a class="btn btn-warning" href="<?php echo base_url()?>index.php/relatorio/gerar_relatorio_uso_motorista/<?php echo $data_inicial."/".$data_final."/".$motorista?>"><i class="fa fa-file-pdf-o"></i> Gerar PDF</a>
					<a class="btn btn-danger" href="<?php echo base_url()?>index.php/relatorio/relatorio_uso_motorista"><i class="fa fa-times"></i> Voltar</a>
				<?php }?>
			</div>
		<?php echo form_close()?>
	</div>
